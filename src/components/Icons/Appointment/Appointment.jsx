export const Appointment = ({ width = 24, height = 24 }) => {
    return (
        <svg
            width={width}
            height={height}
        ...
        >
            <path
                opacity="0.5"
                d="M9 14.2353V17C9 19.7614 11.2386 22 14 22H14.8824C16.7691 22 18.3595 20.731 18.8465 19"
                stroke="#4B60D7"
                strokeWidth="1.5"
            />
            <path
                ...
                strokeLinecap="round"
            />
            <circle cx="19" cy="16" r="3" stroke="#4B60D7" strokeWidth="1.5" />
            <path
                d="M12 2V4"
                stroke="#4B60D7"
                strokeWidth="1.5"
